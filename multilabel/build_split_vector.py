...
def build_img_vec(json, vocab, vocab_n, vocab_j, vocab_v):
    ...
    for i, id in enumerate(ids):
        ...
        imagetoken2vec.add_caption(image_id, vec_n, vec_j, vec_v)
        if (i+1) % 1000 == 0:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--vocab_path', type=str, default='./data/lemmatized_vocab_no_adv.pkl', 
    ...
    parser.add_argument('--imgtoken2vec_path', type=str, default='./data/imgtoken2vec.pkl',
